[![Build Status](https://dev.azure.com/techjb/ConfigDocs/_apis/build/status/ConfigDocs.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/techjb/ConfigDocs/_build/latest?definitionId=1&branchName=master)
